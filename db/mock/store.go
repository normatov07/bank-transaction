...
// ListTrasfers mocks base method.
func (m *MockStore) ListTrasfers(arg0 context.Context, arg1 db.ListTrasfersParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTrasfers", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTrasfers indicates an expected call of ListTrasfers.
func (mr *MockStoreMockRecorder) ListTrasfers(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTrasfers", reflect.TypeOf((*MockStore)(nil).ListTrasfers), arg0, arg1)
}
